        ...
        <section id="start" class="section section-full">
            ...
            <div class="heading fade-in">
                ...
                <p class="text fading-text">
                  <span>Unikalūs web dizaino ir programavimo projektai, taip pat</span>
                  <span>WordPress svetainės ir kiti dizaino darbai, kuriuos</span>
                  <span>įgyvendinau per pastaruosius 6 metus.</span>
                </p>
